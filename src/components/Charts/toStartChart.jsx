...
const TaskChart = () => {
    ...
    const apiUrls = {
        day: 'https://taskmanager-yxx2.onrender.com/api/task/task-counts-by-day-to-start',
        month: 'https://taskmanager-yxx2.onrender.com/api/task/task-counts-by-month-to-start',
        year: 'https://taskmanager-yxx2.onrender.com/api/task/task-counts-by-year-to-start',
    };
    ...
    return (
        <div className="taskChart" >
            <div className='toStart-header' >
                <h2>Task Start Date</h2>
                <select
                    className='toStart-select'
                    value={view}
